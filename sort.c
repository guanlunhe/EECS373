...
void new_sort( int *number, unsigned count)
{
	qsort(number, (size_t)count, sizeof(int), new_compare);
...
sorting_fn sorting_fns[] = {bubble_sort, insertion_sort, new_sort, NULL};
